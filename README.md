...
The current project include JWT login, UnitTest and RabitMQ to call service stock between Django projects 

* Step 1: run migrations in api_service
  *   python manage.py migrate

* Step 2: Create superuser in api_service with 
  *   python manage.py createsuperuser

* Step 3: run services in api_service and stock_service 
  *   python manage.py runserver

* Step 4: run celery in api_service and stock_service 
  *   celery -A  stock_service  worker --loglevel=info -E
  *   celery -A api_service worker --loglevel=info -E

* Step 5: Create a Post Method to get the token localhost:8000/api/token/ 
  * {
      "username": "",
      "password": ""
  }
  
* Step 6: Start with api calls  sharing Authentication Bared Token